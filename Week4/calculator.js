...
function sub(num3, num4){
    ...
    document.getElementById("answer").innerHTML = Number(num3) - Number(num4);
};
...
function mul(num5, num6){
    ...
    document.getElementById('answer').innerHTML = Number(num5) * Number(num6);
};
...
function div(num7, num8){
    ...
    document.getElementById('answer').innerHTML = Number(num7) / Number(num8)
};
